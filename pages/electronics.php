...
$select="select * from product where type='electronics' order by ProductId desc ";
...
<div class="text-center fs-3">
    ...
    <div class="row">
        ...
        <div  style="overflow: hidden;" class="col-lg-2 col-md-3 col-sm-6">
            <img class="img-food"  style="width:100% ; height:100px;" src="../image/electronics/<?=$row['image']?>" alt="">
            <p class="text-center">
                <?= $row["ProductName"] ?>
            </p>
